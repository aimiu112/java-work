...
public class ClosestPointInThree {
	public static void main(String[] args) {
		Scanner input = new Scanner(System.in);{
		try {
			double[][] points = {{-1,0,3},{-1,-1,-1},{4,1,1},{2,0.5,9},{3.5,2,-1},{3,2,-1},{3,1.5,3},{-1.5,4,2},{5.5,4,-0.5}};
//			double [][] points=new double[9][3];
//			for(int i=0;i<points.length;i++) {
//				points[i][0]=input.nextDouble();
//				points[i][1]=input.nextDouble();
//				points[i][2]=input.nextDouble();
//			}
//			-1 0 3 -1 -1 -1 4 1 1 2 0.5 9 3.5 2 -1 3 2 -1 3 1.5 3 -1.5 4 2 5.5 4 -0.5
			int p1=0,p2=1;
